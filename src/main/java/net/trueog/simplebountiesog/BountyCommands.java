...
public class BountyCommands implements CommandExecutor {
    ...
    private void sendHelpMessage(CommandSender sender) {
        ...
        if (sender instanceof Player) {
            ...
            main.getLogger()
                    .info("/bounty edit <target> (optional - placer) <new_reward> - Edit an existing bounty's reward.");
            ...
            case "list":
                if (bounties.isEmpty()) {
                    ...
                    for (Bounty bounty : bounties) {
                        ...
                        UtilitiesOG.trueogMessage(
                                player,
                                "<gold>BOUNTY: " + bounty.TARGET + " PLACER: " + bounty.SENDER + " REWARD: <red>$"
                                        + bounty.REWARD + "</red></gold>");
                    }
            ...
            case "list":
                if (bounties.isEmpty()) {
                    ...
                    for (Bounty bounty : bounties) {
                        ...
                        sender.sendMessage("BOUNTY: " + bounty.TARGET + " PLACER: " + bounty.SENDER + " REWARD: $"
                                + bounty.REWARD);
                    }
        ...
        if (isValidTarget(target)) {
            ...
            if (sender instanceof Player) {
                ...
                if (!hasPlacedBounty(pSender.getName(), target)) {
                    ...
                    UtilitiesOG.trueogMessage(
                            pSender, "<green>Bounty placed on: </green>" + "<yellow>" + target + "<green>.</green>");
                    ...
                    for (Player player : Bukkit.getOnlinePlayers()) {
                        ...
                        UtilitiesOG.trueogMessage(
                                player,
                                "<gold>" + pSender.getName() + " has placed a BOUNTY on " + target + " for <red>$"
                                        + reward + "</red></gold>");
                    }
                    ...
                    UtilitiesOG.trueogMessage(
                            pSender, "<red>Bounty not placed: insufficient funds or invalid reward amount.</red>");
                }
                ...
                if (sender instanceof Player) {
                    ...
                    UtilitiesOG.trueogMessage(
                            pSender, "<red>You have already placed a bounty on " + target + ".</red>");

                } else {

                    UtilitiesOG.logToConsole(
                            "[SimpleBounties-OG]", "<red>You have already placed a bounty on " + target + ".</red>");
                }
            }
            ...
            if (sender instanceof Player && placer.equals("null")) {
                ...
                for (Bounty bounty : bounties) {
                    ...
                    if (bounty.SENDER.equalsIgnoreCase(sender.getName()) && bounty.TARGET.equalsIgnoreCase(target)) {
                        ...
                        UtilitiesOG.trueogMessage(
                                p,
                                "<green>Bounty on " + target + ": reward edited to <red>$" + reward + "</red></green>");
                ...
                if (sender instanceof Player) {
                    ...
                    for (Bounty bounty : bounties) {
                        ...
                        if (bounty.SENDER.equalsIgnoreCase(placer) && bounty.TARGET.equalsIgnoreCase(target)) {
                            ...
                            UtilitiesOG.trueogMessage(
                                    p, "<green>Bounty on " + target + " edited to <red>$" + reward + "</red></green>");
    ...
    public void completeBounty(String killed, String killer) {
        ...
        for (Player player : Bukkit.getOnlinePlayers()) {
            ...
            UtilitiesOG.trueogMessage(
                    player,
                    "<gold>" + killer + " has completed a bounty on " + killed + " for</gold> <aqua>" + amt
                            + "Diamonds </aqua>");
        }
    }
}
